...
public class Class2BodyNotEmpty extends ClassBody2 {

    private Type Type;
    private ClassBodyInternal ClassBodyInternal;

    public Class2BodyNotEmpty (Type Type, ClassBodyInternal ClassBodyInternal) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Class2BodyNotEmpty(\n");
