...
public class ClassBody2WithConstructorVoids extends ClassBody2 {

    private ConstructorDecl ConstructorDecl;
    private MethodDeclsVoid MethodDeclsVoid;

    public ClassBody2WithConstructorVoids (ConstructorDecl ConstructorDecl, MethodDeclsVoid MethodDeclsVoid) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassBody2WithConstructorVoids(\n");
