...
public class SingleStatementNoLabel extends Statement {

    private SingleStatement SingleStatement;

    public SingleStatementNoLabel (SingleStatement SingleStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleStatementNoLabel(\n");
