...
public class ConstructorDeclNoIdent implements SyntaxNode {
    ...
    public ConstructorDeclNoIdent (VarDecls VarDecls, Statements Statements) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstructorDeclNoIdent(\n");
