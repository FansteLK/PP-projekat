...
public class ClassBody2NoConstructorVoid extends ClassBody2 {

    private MethodDeclsVoid MethodDeclsVoid;

    public ClassBody2NoConstructorVoid (MethodDeclsVoid MethodDeclsVoid) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassBody2NoConstructorVoid(\n");
